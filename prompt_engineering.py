...
class PromptEngineer:
    ...
    def _build_templates(self) -> Dict[str, str]:
        ...
        # 객관식 템플릿
        templates["mc_basic"] = """당신은 금융보안 전문가입니다.
...
정답 번호:"""
        ...
        templates["mc_negative"] = """당신은 금융보안 전문가입니다.
...
정답 번호:"""
        ...
        templates["mc_domain"] = """당신은 {domain} 전문가입니다.
...
{domain} 관점에서 정답을 선택하세요.
정답 번호:"""

        # 주관식 템플릿
        templates["subj_basic"] = """당신은 금융보안 전문가입니다.
...
답변:"""
        ...
        templates["subj_domain"] = """당신은 {domain} 전문가입니다.
...
답변:"""
    ...
    def _build_examples(self) -> Dict[str, List[Dict]]:
        ...
        examples = {
            "mc_personal_info": {
                ...
                "answer": "2",
                "reasoning": "개인정보보호법 제2조 제1호에 따르면 개인정보는 '살아 있는 개인에 관한 정보로서 개인을 알아볼 수 있는 정보'입니다."
            },
            "mc_electronic": {
                "question": "전자금융거래의 정의로 옳은 것은?\n1. 모든 금융거래\n2. 전자적 장치를 통한 금융상품 및 서비스 제공·이용 거래\n3. 인터넷뱅킹만\n4. 신용카드 거래만\n5. 현금거래",
                "answer": "2",
                "reasoning": "전자금융거래법 제2조에 따르면 전자금융거래는 '전자적 장치를 통하여 금융상품과 서비스를 제공하고 이용하는 거래'입니다."
            },
            "subj_security": {
                "question": "금융기관의 개인정보보호 관리체계 구축 방안을 설명하시오.",
                "answer": "금융기관의 개인정보보호 관리체계는 다음과 같이 구축해야 합니다. 첫째, 개인정보보호 정책 및 지침을 수립하고 최고경영진의 책임 하에 운영합니다. 둘째, 개인정보보호 책임자와 담당자를 지정하여 전담 조직을 구성합니다. 셋째, 개인정보의 수집·이용·제공·파기 등 전 생명주기에 걸친 관리 절차를 수립합니다. 넷째, 암호화, 접근통제 등 기술적·관리적·물리적 안전성 확보조치를 구현합니다. 다섯째, 정기적인 점검과 감사를 통해 지속적으로 개선합니다."
            }
        }
        return examples
    ...
    def _generate_domain_context(self, domain: str) -> str:
        """도메인 컨텍스트 생성"""
        contexts = {
            "개인정보보호": "개인정보보호법에 따라 개인정보는 정보주체의 동의 하에 수집·이용되어야 하며, 안전성 확보조치를 통해 보호되어야 합니다.",
            "전자금융": "전자금융거래법에 따라 전자적 장치를 통한 금융거래의 안전성과 신뢰성을 확보해야 합니다.",
            "정보보안": "정보보호관리체계(ISMS)를 통해 체계적인 보안 관리와 지속적 개선이 필요합니다.",
            "암호화": "중요 정보는 안전한 암호 알고리즘으로 암호화하여 기밀성과 무결성을 보장해야 합니다.",
    ...
    def create_few_shot_prompt(self, question: str, question_type: str,
        ...
        prompt_parts = ["다음은 금융보안 문제 예시입니다.\n"]
        ...
        prompt_parts.append("위 예시를 참고하여 답하세요.")
