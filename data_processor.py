...
class DataProcessor:
    ...
    def _initialize_data(self):
        ...
        self.question_intent_patterns = {
            ...
            "조치_묻기": [
                ...
                "대응.*조치", "예방.*조치", ".*조치", "보완.*조치"
            ],
            "법령_묻기": [
                "법령.*설명", "법률.*설명", "규정.*설명", "조항.*설명", "규칙.*설명",
                "기준.*설명", "법적.*근거", "관련.*법", "적용.*법"
            ],
            "정의_묻기": [
    ...
    def analyze_question_intent(self, question: str) -> Dict:
        ...
        if intent_scores:
            ...
            intent_analysis["intent_confidence"] = min(best_intent[1]["score"] / 5.0, 1.0)
