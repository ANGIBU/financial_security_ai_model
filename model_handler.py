...
class ModelHandler:
    ...
    def _initialize_data(self):
        ...
        self.domain_templates = {
            ...
            "전자금융": {
                ...
                "정보기술부문비율": "전자금융감독규정에 따르면 금융회사는 정보보호 예산 관리 시 정보기술부문 인력 5% 이상, 정보기술부문 예산 7% 이상을 정보보호 업무에 배정하는 것이 기준 비율입니다."
            },
            "개인정보보호": {
    ...
    def get_domain_template_answer(self, question: str, domain: str) -> str:
        ...
        keyword_matches = {
            ...
            "한국은행": ["한국은행", "자료제출", "요구"],
            "보안조치": ["전자금융업자", "보안조치"],
            "예산비율": ["정보보호", "예산", "비율", "정보기술부문"],
            "정보기술부문비율": ["정보기술부문", "인력", "예산", "비율", "얼마", "기준"],
            "위원회": ["개인정보보호위원회", "신고", "상담"],
        ...
        for template_key, keywords in keyword_matches.items():
            if template_key in templates:
                ...
                elif template_key == "예산비율":
                    if "정보보호" in question_lower and "예산" in question_lower and "비율" in question_lower:
                        return templates[template_key]
