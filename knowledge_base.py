...
class FinancialSecurityKnowledgeBase:
    ...
    def get_institution_hints(self, institution_type: str) -> str:
        """기관 힌트 제공"""
        default_hints = {
            "전자금융분쟁조정": "전자금융분쟁조정위원회에서 전자금융거래 관련 분쟁조정 업무를 담당합니다. 이 위원회는 금융감독원 내에 설치되어 운영됩니다.",
            "개인정보보호": "개인정보보호위원회에서 개인정보 보호에 관한 업무를 총괄합니다. 개인정보 침해 신고는 개인정보침해신고센터에서 담당합니다.",
            "금융투자분쟁조정": "금융분쟁조정위원회에서 금융투자 관련 분쟁조정 업무를 담당합니다. 이 위원회는 금융감독원 내에 설치되어 있습니다.",
            "한국은행": "한국은행에서 통화신용정책 수행과 지급결제제도 운영을 담당합니다. 금융통화위원회의 요청에 따라 자료제출을 요구할 수 있습니다.",
        }
